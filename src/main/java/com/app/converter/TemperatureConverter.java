...
public class TemperatureConverter extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new Font("Serif", 1, 24));
        ...
        jButton3.setFont(new java.awt.Font("Serif", 3, 14));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        assert val1 != null;
        if(val1.equals("Celsius") && Objects.equals(val2, "Fahrenheit")){
            ...
            if(val1.equals("Celsius")) {
                assert val2 != null;
                if (val2.equals("Celsius")) {
        ...
        if(val1.equals("Fahrenheit") && Objects.equals(val2, "Celsius"))
        {
            ...
            if(val1.equals("Fahrenheit")) {
                assert val2 != null;
                if (val2.equals("Fahrenheit")) {
                    double f = Double.parseDouble(jTextField1.getText());
